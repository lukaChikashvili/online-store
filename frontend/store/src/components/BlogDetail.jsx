...
const BlogDetail = () => {
  ...
  return (
    <div className='w-full flex flex-col gap-4 items-center justify-center mt-12'>
       ...
       <div className='flex flex-col items-center justify-center px-[10rem] gap-[5rem] mt-12'>
      

         <img src = {`${BASE_URL}${blogs?.image}`} onError={handleImageError}  className='w-[70rem] h-[20rem] rounded-md shadow-lg object-cover' />
