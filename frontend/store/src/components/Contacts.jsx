  ...
  return (
    <div className='w-full h-screen'>
      <div className='flex flex-col items-center justify-center gap-4'>
        ...
        <div className='flex items-center justify-center gap-[10rem] mt-[10rem]'>
          <a 
          ...
          >
            <img 
              src={face} 
              alt="Facebook" 
              className='w-[10rem] transition-transform transform hover:scale-110 duration-300'
            />
          </a>
          <a 
          ...
          >
            ...
            <img onClick={() => setModal(!modal)} 
              src={tele} 
              alt="Telephone" 
              className='w-[10rem] transition-transform transform hover:scale-110 duration-300 cursor-pointer'
            />
