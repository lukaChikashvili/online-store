  ...
  return (
    <div className='w-full min-h-screen mt-[10rem] px-[4rem] '>
       <div className='flex flex-col items-center gap-4'>
         ...
         <div className='flex items-center gap-[4rem] justify-center mt-12 '>
             <div className='flex flex-col  gap-8'>
            <p className='text-xl w-[40rem] leading-[2rem] '>
     ...
     <div className='flex gap-8 '>
          ...
          <button onClick={() => navigate('/login')} className="w-[15rem] relative group overflow-hidden px-8 py-1 bg-blue text-white rounded-md">
            ...
            <img src = {man} className='w-[25rem] rounded-full shadow-lg cursor-pointer duration-500 ease hover:grayscale'/>
         </div>
       </div>
    </div>
  )
